...
export const electronAPIMock = {
    ...
    getLibraryDisplayMode: async () => ({ libraryDisplayMode: 'grid' as const }),
    setLibraryDisplayMode: async () => ({ success: true, libraryDisplayMode: 'grid' as const }),
    getLibraryListColumns: async () => ({ libraryListColumns: 1 }),
    setLibraryListColumns: async () => ({ success: true, libraryListColumns: 1 }),

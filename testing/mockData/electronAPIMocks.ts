...
export const electronAPIMock = {
    ...
    refreshPlaylist: async () => ({ success: true, added: 0, removed: 0, updated: 0, entries: [], missingFromLibraryEntries: [] }),
    setPlaylistManualThumbnail: async () => ({ success: true, manualThumbnailVideoId: null, thumbnailUrl: null, thumbnailPath: null }),

...
<!-- Update the version in these 5 links on every release, currently 1.1.1.
     Each filename must match exactly what GitHub actually named the asset on
     the release page -->

| Platform | Link |
|---|---|
| Windows (installer) | [Download](https://github.com/SlothSoftworks/Sloth-Archiver/releases/download/v1.1.1/SlothArchiver.Setup.1.1.1.exe) |
| Windows (portable, no install) | [Download](https://github.com/SlothSoftworks/Sloth-Archiver/releases/download/v1.1.1/SlothArchiver.1.1.1.exe) |
| macOS (Apple Silicon) | [Download](https://github.com/SlothSoftworks/Sloth-Archiver/releases/download/v1.1.1/SlothArchiver-1.1.1-arm64.dmg) |
| macOS (Intel) | [Download](https://github.com/SlothSoftworks/Sloth-Archiver/releases/download/v1.1.1/SlothArchiver-1.1.1.dmg) |
| Linux (AppImage) | [Download](https://github.com/SlothSoftworks/Sloth-Archiver/releases/download/v1.1.1/SlothArchiver-1.1.1.AppImage) |

...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    getResumeTrackingMode: () => ipcRenderer.invoke('settings:getResumeTrackingMode'),
    ...
    savePlaybackPosition: (payload) => ipcRenderer.invoke('library:savePlaybackPosition', payload),

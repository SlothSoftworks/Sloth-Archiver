...
const invokeTable = [
  ...
  ['listLibraryTags', [], ['library:listTags']],
  ['createLibraryTag', ['Music'], ['library:createTag', 'Music']],
  ['listVideoTags', [], ['library:listVideoTags']],
  ['setVideoTag', ['TVshows', 'vid1', true], ['library:setVideoTag', { tagName: 'TVshows', videoId: 'vid1', applied: true }]],
  ['tagVideos', [['vid1', 'vid2'], 'TVshows'], ['library:tagVideos', { videoIds: ['vid1', 'vid2'], tagName: 'TVshows' }]],
  ['getActiveLibraryTag', [], ['settings:getActiveLibraryTag']],
  ['setActiveLibraryTag', ['Music'], ['settings:setActiveLibraryTag', 'Music']],
  ...
  ['addLibraryEntry', [{ id: 1 }, 'Music'], ['library:addEntry', { id: 1 }, 'Music']],
  ['overrideLibraryEntry', [{ id: 1 }, '/v', 'Music'], ['library:overrideEntry', { videoMetaData: { id: 1 }, existingVideoDir: '/v' }, 'Music']],
  ['addLibraryVersion', [{ id: 1 }, '/v'], ['library:addVersion', { videoMetaData: { id: 1 }, videoDir: '/v' }]],
  ['findLibraryVideo', ['vid', 'Music'], ['library:findVideo', 'vid', 'Music']],
